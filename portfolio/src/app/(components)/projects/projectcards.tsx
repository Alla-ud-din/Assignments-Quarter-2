...
export default function ProjectCards({ imgUrl, title, description }: ProjectCardsProps) {

  return (
    <div className='mx-8'>
      <div className="group rounded-t-xl h-36 md:h-36 bg-center relative overflow-hidden" 
        style={{ 
      ...
      >
        <div className="overlay absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500 items-center justify-center">
          <Link href="/" className="h-14 w-14 border-2 relative rounded-full border-[#ADB7BE] hover:border-white mr-4 group/link">
